...
const CustomShellProcessBuilder = require('./custom-shell-process-builder');
const DefaultShellProcessBuilder = require('./default-shell-process-builder');
    ...
    get _shellCommandService() {
        return new ShellCommandService({
            processBuilderProvider: new ProcessBuilderProvider({
                customShellProcessBuilder: new CustomShellProcessBuilder({
                    childProcess,
                ...
                defaultShellProcessBuilder: new DefaultShellProcessBuilder({
                    childProcess,
                    shellCommandExecContext: this._shellCommandExecContext
                }),
                shellProgrammeResolver: this._shellProgrammeResolver
