...
const CustomProcessBuilder = require('./process-builder');
const DefaultProcessBuilder = require('./default-process-builder');
    ...
    get _shellCommandService() {
        return new ShellCommandService({
            processBuilderProvider: new ProcessBuilderProvider({
                customProcessBuilder: new CustomProcessBuilder({
                    childProcess,
                ...
                defaultProcessBuilder: new DefaultProcessBuilder({
                    childProcess,
                    shellCommandExecContext: this._shellCommandExecContext
                }),
                shellProgrammeResolver: this._shellProgrammeResolver
